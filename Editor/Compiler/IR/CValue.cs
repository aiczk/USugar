...
public sealed class CInternalCall : CValue
{
    ...
    /// is in CycleCalleeNames. It may be absent from RecursiveCalleeNames when this emitted
    /// specialization has no non-tail site, because that set is reserved for actual spill work.
    /// Must be copied by every site that reconstructs the instruction, like <see cref="Reentrant"/>.</summary>
