...
internal sealed class LoopHandler
{
    ...
    void VisitForEachLoop(IForEachLoopOperation op)
    {
        ...
        var arrayType = _lowering.GetArrayType(arrayTypeSymbol);
        var elemAccessorType = _lowering.GetArrayElemType(arrayTypeSymbol);
        ...
        _lowering.Builder.EmitFor(
            ...
            _ =>
            {
                ...
                if (arrayTypeSymbol.ElementType is INamedTypeSymbol elemAgg && _lowering.IsAggregateValue(elemAgg))
