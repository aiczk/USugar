...
public interface IExpressionHandler : IHandler
{
    // A-normal form: every expression result is an operand-safe leaf (CSlotRef/CConst/CFuncRef/CFieldAddr/CTypedView,
