...
public sealed class UdonTypeSystem
{
        ...
        IReadOnlyDictionary<ITypeParameterSymbol, ITypeSymbol> typeParameterMap = null)
    {
        ...
        var sourceType = UdonTypeIdentity.From(resolved);
        ...
        var storage = new StorageType(ExternResolver.GetUdonTypeName(
            resolved, typeParameterMap, _facts, IsRegisteredUdonTypeName));
    ...
    public UdonTypeLowering Describe(Type type)
    {
        ...
        var sourceType = UdonTypeIdentity.From(type);
        ...
        UdonRuntimeTypeTest runtimeTypeTest)
    {
        ...
        return new UdonTypeLowering(
            sourceType, storage, representation, runtimeTypeTest, evidence);
    }
    ...
    StorageType LowerClrStorage(Type type)
    {
        ...
        if (type.IsArray)
        {
            ...
            return new StorageType(
                UdonTypeIdentity.FromCanonicalName(
        ...
        var exactType = UdonTypeIdentity.From(type);
